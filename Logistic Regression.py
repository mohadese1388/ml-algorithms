...
# === اضافه شده: PCA برای کاهش بعد و تشخیص اطلاعات جدید ===
pca = PCA(n_components=0.95)  # یا n_components=2 برای 2 بعد
...
print("Accuracy Logistic Regression (با PCA):", accuracy_score(y_test, y_pred))

plt.figure(figsize=(6,5))
sns.heatmap(confusion_matrix(y_test, y_pred), annot=True, fmt='d', cmap='Blues')
plt.title('Confusion Matrix - Logistic Regression (با PCA)')
plt.show()
